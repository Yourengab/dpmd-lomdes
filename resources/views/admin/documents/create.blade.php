...
<head>
    ...
    <title>Add New Document - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Add New Document</h2>
                <p class="text-gray-600 mt-2">Upload official documents for participants to access</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.documents.store') }}" class="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="village" {{ old('category') === 'village' ? 'selected' : '' }}>Village (Desa)</option>
                        <option value="district" {{ old('category') === 'district' ? 'selected' : '' }}>District (Kelurahan)</option>
                    </select>
                    @error('category')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
        ...
        <div class="mt-8 bg-blue-50 rounded-xl p-6">
            <h3 class="text-lg font-semibold text-blue-800 mb-3">
                <i class="fas fa-lightbulb mr-2"></i>Document Upload Tips
            </h3>
            <div class="space-y-2 text-blue-700">
                <p><strong>Google Drive:</strong> Make sure to set sharing permissions to "Anyone with the link can view"</p>
                <p><strong>Google Docs/Sheets:</strong> Use the "Share" button and copy the public link</p>
                <p><strong>Categories:</strong> Village documents are for Desa participants, District documents are for Kelurahan participants</p>
                <p><strong>File Types:</strong> PDF, DOC, XLS, PPT files work best for participants</p>
            </div>
        </div>
    </div>
</body>
