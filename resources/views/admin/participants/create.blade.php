...
<head>
    ...
    <title>Add New Participant Spreadsheet - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Add New Participant Spreadsheet</h2>
                <p class="text-gray-600 mt-2">Create a new participant spreadsheet link</p>
        ...
        <div class="bg-white rounded-xl shadow-md p-8">
            <form method="POST" action="{{ route('admin.participants.store') }}" class="space-y-6">
                ...
                <div class="flex justify-end space-x-4 pt-6">
                    ...
                    >
                        <i class="fas fa-save mr-2"></i>Create Spreadsheet
                    </button>
                </div>
            </form>
        </div>
