...
<head>
    ...
    <title>Edit Participant Spreadsheet - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            <a href="{{ route('admin.participants.index') }}" class="mr-4 text-gray-600 hover:text-gray-800">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Edit Participant Spreadsheet</h2>
                <p class="text-gray-600 mt-2">Update participant spreadsheet information</p>
            ...
            <form method="POST" action="{{ route('admin.participants.update', $participant) }}" class="space-y-6">
                ...
                <div>
                    ...
                    <input
                        ...
                        id="title"
                        name="title"
                        value="{{ old('title', $participant->title) }}"
                        ...
                        placeholder="e.g., Participant List 2025"
                        required
                    >
                    @error('title')
                ...
                <div>
                    <label for="link" class="block text-sm font-medium text-gray-700 mb-2">
                        <i class="fas fa-link mr-2"></i>Spreadsheet Link *
                    </label>
                    <input
                        type="url"
                        id="link"
                        name="link"
                        value="{{ old('link', $participant->link) }}"
                ...
                <div class="flex justify-end space-x-4 pt-6">
                    <a href="{{ route('admin.participants.index') }}" class="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition duration-200">
                        Cancel
                    </a>
                    <button
                        type="submit"
                    ...
                    >
                        <i class="fas fa-save mr-2"></i>Update Spreadsheet
                    </button>
                </div>
            </form>
        </div>
