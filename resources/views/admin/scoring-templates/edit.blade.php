...
<head>
    ...
    <title>Edit Scoring Template - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Edit Scoring Template</h2>
                <p class="text-gray-600 mt-2">Update scoring template information</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-xl shadow-md p-8">
            <form method="POST" action="{{ route('admin.scoring-templates.update', $scoringTemplate) }}" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input 
                        ...
                        id="title" 
                        name="title" 
                        value="{{ old('title', $scoringTemplate->title) }}"
                ...
                <div>
                    ...
                    <select 
                        id="category" 
                        name="category" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('category') border-red-500 @enderror"
                        required
                        onchange="toggleFields()"
                    >
                        <option value="">Choose template category</option>
                        <option value="tahap_administrasi" {{ old('category', $scoringTemplate->category) === 'tahap_administrasi' ? 'selected' : '' }}>Tahap Administrasi</option>
                        <option value="tahap_pemaparan" {{ old('category', $scoringTemplate->category) === 'tahap_pemaparan' ? 'selected' : '' }}>Tahap Pemaparan</option>
                        <option value="tahap_klarifikasi_lapangan" {{ old('category', $scoringTemplate->category) === 'tahap_klarifikasi_lapangan' ? 'selected' : '' }}>Tahap Klarifikasi Lapangan</option>
                        <option value="daftar_inovasi" {{ old('category', $scoringTemplate->category) === 'daftar_inovasi' ? 'selected' : '' }}>Daftar Inovasi Desa & Kelurahan</option>
                    </select>
                    @error('category')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div id="document_selection" style="display: none;">
                    ...
                    <select 
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('admin_document_id') border-red-500 @enderror"
                    >
                        <option value="">Choose a document to create scoring template for</option>
                        @foreach($documents as $document)
                            <option value="{{ $document->id }}" {{ old('admin_document_id', $scoringTemplate->admin_document_id) == $document->id ? 'selected' : '' }}>
                ...
                <div id="spreadsheet_url_field" style="display: none;">
                    ...
                    <input 
                        ...
                        value="{{ old('spreadsheet_url', $scoringTemplate->spreadsheet_url) }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('spreadsheet_url') border-red-500 @enderror"
                ...
                <div id="event_date_field" style="display: none;">
                    ...
                    <input 
                        ...
                        id="event_date" 
                        name="event_date" 
                        value="{{ old('event_date', $scoringTemplate->event_date ? $scoringTemplate->event_date->format('Y-m-d') : '') }}"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('event_date') border-red-500 @enderror"
                    >
                    @error('event_date')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('questions_spreadsheet_url', $scoringTemplate->questions_spreadsheet_url) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('questions_spreadsheet_url') border-red-500 @enderror"
                                placeholder="https://docs.google.com/spreadsheets/d/..."
                            >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('village_spreadsheet_url', $scoringTemplate->village_spreadsheet_url) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('village_spreadsheet_url') border-red-500 @enderror"
                                placeholder="https://docs.google.com/spreadsheets/d/..."
                            >
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('district_spreadsheet_url', $scoringTemplate->district_spreadsheet_url) }}"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent transition duration-200 @error('district_spreadsheet_url') border-red-500 @enderror"
                                placeholder="https://docs.google.com/spreadsheets/d/..."
                            >
                ...
                <div>
                    ...
                    >{{ old('description', $scoringTemplate->description) }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
