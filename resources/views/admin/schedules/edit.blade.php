...
<head>
    ...
    <title>Edit Schedule - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Edit Schedule</h2>
                <p class="text-gray-600 mt-2">Update presentation schedule information</p>
            </div>
        </div>
            ...
            <form method="POST" action="{{ route('admin.schedules.update', $schedule) }}" class="space-y-6">
                ...
                <div>
                    ...
                    >
                        ...
                        <option value="desa" {{ old('type', $schedule->type) === 'desa' ? 'selected' : '' }}>Desa</option>
                        <option value="kelurahan" {{ old('type', $schedule->type) === 'kelurahan' ? 'selected' : '' }}>Kelurahan</option>
                    </select>
                    @error('type')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input
                        ...
                        id="meet_link"
                        name="meet_link"
                        value="{{ old('meet_link', $schedule->meet_link) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            id="top_village_1"
                            name="top_village_1"
                            value="{{ old('top_village_1', $schedule->top_village_1) }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="time_1"
                            name="time_1"
                            value="{{ old('time_1', $schedule->time_1) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            id="top_village_2"
                            name="top_village_2"
                            value="{{ old('top_village_2', $schedule->top_village_2) }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="time_2"
                            name="time_2"
                            value="{{ old('time_2', $schedule->time_2) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input
                            ...
                            id="top_village_3"
                            name="top_village_3"
                            value="{{ old('top_village_3', $schedule->top_village_3) }}"
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="time_3"
                            name="time_3"
                            value="{{ old('time_3', $schedule->time_3) }}"
