...
<head>
    ...
    <title>Add New Video Submission - DPMD Lomdes</title>
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="flex items-center mb-8">
            ...
            <div>
                <h2 class="text-3xl font-bold text-gray-800">Add New Video Submission</h2>
                <p class="text-gray-600 mt-2">Create a new video submission link</p>
            </div>
        </div>

        <!-- Form -->
        <div class="bg-white rounded-xl shadow-md p-8">
            <form method="POST" action="{{ route('admin.video-submissions.store') }}" class="space-y-6">
                @csrf
                ...
                <div class="flex justify-end space-x-4 pt-6">
                    ...
                    >
                        <i class="fas fa-save mr-2"></i>Create Video Submission
                    </button>
                </div>
            </form>
        </div>
