...
<head>
    ...
    <title>Pendaftaran Desa - DPMD Bali</title>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('register.index') }}" class="text-gray-600 hover:text-green-600 transition duration-200">
    ...
    <div class="min-h-screen py-16">
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl font-bold text-gray-800 mb-4">Pendaftaran Desa</h1>
                <p class="text-xl text-gray-600 mb-2">Lomba Desa Provinsi Bali</p>
                <p class="text-gray-500">Isi formulir pendaftaran di bawah ini untuk mendaftar lomba desa</p>
            </div>
                    ...
                    @foreach($documents as $document)
                        <div class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition duration-300">
                            <div class="bg-gradient-to-r from-green-500 to-green-600 p-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-green-100 text-sm">Formulir Pendaftaran Desa</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="space-y-3">
                                    <!-- Form Button -->
                                    <a href="{{ route('register.form', $document->id) }}" class="flex items-center justify-center w-full bg-green-600 hover:bg-green-700 text-white py-3 px-6 rounded-lg font-semibold transition duration-200">
            ...
            @else
                ...
                <div class="text-center py-16">
                    <div class="w-24 h-24 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-file-alt text-green-600 text-4xl opacity-50"></i>
                    </div>
                    <h3 class="text-2xl font-semibold text-gray-800 mb-4">Belum Ada Dokumen</h3>
                    <p class="text-gray-600 mb-8">Dokumen pendaftaran untuk desa belum tersedia saat ini.</p>
                    <a href="{{ route('register.index') }}" class="inline-flex items-center bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition duration-200">
            ...
            <div class="mt-16 bg-white rounded-xl shadow-md p-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Ikuti langkah berikut untuk mendaftar lomba desa</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-600 text-sm">Ingat untuk <strong>mengupload semua berkas</strong> yang telah disiapkan</p>
                    </div>
            ...
            <div class="mt-8 bg-green-50 rounded-xl p-6">
                <div class="flex items-center justify-center mb-4">
                    ...
                    <div>
                        <h4 class="font-semibold text-green-800">Butuh Bantuan?</h4>
                        <p class="text-green-600 text-sm">Hubungi panitia jika mengalami kesulitan</p>
                    </div>
                </div>
            </div>
        </div>
