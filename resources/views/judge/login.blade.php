...
<head>
    ...
    <title>Judge Login - DPMD Lomdes</title>
...
<body class="bg-gradient-to-br from-green-50 to-emerald-100 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Judge Login</h1>
            <p class="text-gray-600 mt-2">DPMD Lomdes - Bali Province</p>
        </div>

        <!-- Login Form -->
        <form method="POST" action="{{ route('judge.login.post') }}" class="space-y-6">
            @csrf
            ...
            <div>
                ...
                <input 
                    ...
                    name="username" 
                    value="{{ old('username') }}"
                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 @error('username') border-red-500 @enderror"
            ...
            <div>
                ...
                <input 
                    ...
                    id="password" 
                    name="password" 
                    class="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition duration-200 @error('password') border-red-500 @enderror"
